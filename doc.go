...
// of mutate (enqueue/dequeueAppend) operations. Flush syncs the in memory changes of all
// memory mapped files with disk. *This is a best effort flush*. Elapsed time and
// number of mutate operations are only checked upon an enqueue/dequeueAppend.
//
