...
// EnqueueWithTag adds a new slice of byte element to the tail of the queue with an
// identifier tag byte prepended. The tag can be read back via DequeueWithTag without
// parsing the full message payload.
